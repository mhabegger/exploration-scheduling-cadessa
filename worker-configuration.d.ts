/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 49c122a0152bdf42925a886b88bc0708)
...
interface __BaseEnv_CloudflareBindings {
	...
	SCHEDULE_COORDINATOR: DurableObjectNamespace<import("./src/server").ScheduleCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ScheduleCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "OPENROUTER_MODEL">> {}
}
